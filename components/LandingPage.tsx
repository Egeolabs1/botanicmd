...
import { Leaf, Sprout, HeartPulse, Trophy, Star, Smartphone, ArrowRight, CheckCircle, Camera, Zap, Database, HelpCircle, ChevronDown, Flask } from './Icons';
...
export const LandingPage: React.FC<LandingPageProps> = ({ onStart, onOpenPrivacy, onOpenTerms, onOpenAbout, onOpenBlog }) => {
  const { t } = useLanguage();
      ...
      <nav className="w-full py-6 px-6 md:px-12 flex justify-between items-center max-w-7xl mx-auto backdrop-blur-sm sticky top-0 z-40 bg-white/50 border-b border-white/20">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button onClick={() => scrollToSection('features')} className="text-sm font-medium text-gray-600 hover:text-nature-600 transition-colors">
           ...
           <button onClick={onOpenBlog} className="text-sm font-medium text-gray-600 hover:text-nature-600 transition-colors">
            Blog
          </button>
          ...
          <button onClick={onOpenAbout} className="text-sm font-medium text-gray-600 hover:text-nature-600 transition-colors">
            {t('nav_about')}
          </button>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Card 5 - Luxometer */}
             <div className="bg-orange-500 rounded-[2.5rem] p-10 relative overflow-hidden group hover:shadow-xl transition-all duration-300 border border-orange-500 md:col-span-2">
              <div className="relative z-10 max-w-md">
                <div className="w-16 h-16 bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center mb-8 text-white shadow-sm">
                  {/* Assuming Sun icon represents Luxometer, making sure it is available */}
            ...
            {/* Card 6 - CTA */}
             <div className="md:col-span-2 bg-gray-900 rounded-[2.5rem] p-10 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-8">
               ...
               <button onClick={onStart} className="bg-white text-gray-900 px-8 py-4 rounded-2xl font-bold hover:bg-gray-100 transition-colors shadow-lg z-10 whitespace-nowrap">
                 Get Started Free
               </button>
         ...
         <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
               ...
               <div className="bg-nature-50 rounded-3xl p-8 border border-nature-200 hover:shadow-lg transition-shadow">
                  ...
                  <button onClick={onStart} className="w-full py-3 rounded-xl border-2 border-nature-200 font-bold text-nature-800 hover:border-nature-900 hover:text-gray-900 transition-colors bg-white/50">
                     Start Free
                  </button>
               </div>
               ...
               <div className="bg-gray-900 rounded-3xl p-8 border border-gray-800 relative overflow-hidden transform md:scale-105 shadow-2xl">
                  ...
                  <button onClick={onStart} className="w-full py-3 rounded-xl bg-nature-600 text-white font-bold hover:bg-nature-500 transition-colors shadow-lg shadow-nature-900/50">
                     Go Pro
                  </button>
               </div>
            </div>
      ...
      <section className="py-24 px-6">
         <div className="max-w-5xl mx-auto bg-gradient-to-br from-nature-600 to-teal-700 rounded-[3rem] p-12 md:p-24 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
               ...
               <button onClick={onStart} className="bg-white text-nature-800 px-10 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition-all shadow-xl transform hover:scale-105">
                  {t('cta_button')}
               </button>
            </div>
         </div>
      ...
      <footer className="bg-white py-16 px-6 border-t border-gray-100">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
             ...
             <ul className="space-y-2 text-sm text-gray-500">
                <li><button onClick={onOpenAbout} className="hover:text-nature-600 text-left">{t('about_us')}</button></li>
                <li><button onClick={onOpenBlog} className="hover:text-nature-600 text-left">Blog</button></li>
             </ul>
          </div>
           <div>
             <h4 className="font-bold text-gray-900 mb-4">Legal</h4>
             <ul className="space-y-2 text-sm text-gray-500">
                <li><button onClick={onOpenPrivacy} className="hover:text-nature-600 text-left">Privacy Policy</button></li>
                <li><button onClick={onOpenTerms} className="hover:text-nature-600 text-left">Terms of Service</button></li>
             </ul>
          </div>
        </div>
